...
<head>
    ...
    <style>
        ...
        .product-details p {
        margin-top:0px; /* Remove margin for the product description */
        margin-bottom:20px
    }
    .product-name{
        margin-bottom:10px; /* Remove margin for the product description */
...
<div style="height: 100vh; display: flex; flex-direction: column;">
    <header style="background: black; height: 17%; display: flex; justify-content: space-between;">
        ...
        <div>
            <div style="color: white; padding-top: 10px; padding-right: 10px; margin: 10px;">Kredity</div>
            <div style="color: white; padding-right: 10px; margin: 10px; font-size: 40px; font-weight: bold;">500</div>
        </div>
    </header>
    <form action="/search" method="get" style="margin: 15px; text-align: center;">
        <input style="border-radius: 9px; border: solid lightgrey 7px; background-color: lightgrey; color: black; width: 330px; height: 37px;" type="search" id="search-box" name="q" placeholder="Search">
    </form>
    <div style="margin: 10px; text-align: center; font-size: 25px;"> Nealkoholicke napoje</div>
